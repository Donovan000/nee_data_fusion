function [Xdata,Ydata,Vnames] = load_regression_data(exType,Nmin)%,Nmax)
...
elseif strcmpi(exType,'fn') % fluxnet data
    load('fluxnet_Xdata.mat');            % regression inputs
    load('fluxnet_Ydata.mat');            % regression targets
    load('fluxnet_Vnames.mat');           % regression variable names
