...
files = '../data/remote_sensing/modis/fpar';
filelist = dir(files);
...
% Replace land cover fill with grandmas
for f = 1:Nfiles
    for r = 1:Nrows
        for c = 1:Ncols   
...
fprintf('Saving interpFPAR...\n');
save('../data/remote_sensing/for_global_prediction/fpar_interp.mat', 'interpFPAR');
fprintf('Complete.\n');
...
save('../data/remote_sensing/matched_for_training/fpar_matched.mat', 'matchedFPAR');
