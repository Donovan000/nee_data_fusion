clear all; close all; clc; %NEEDS REVISION
%% ~~~ Global Concatenator: Prepare for prediction ~~~

% Load data structures for global variables
fprintf('Loading source data... \n'); tic;
load('../data/remote_sensing/for_global_prediction/ndvi_interp.mat', 'interpNDVI');
load('../data/remote_sensing/for_global_prediction/lstd_interp.mat', 'interpLSTd');
load('../data/remote_sensing/for_global_prediction/lstn_interp.mat', 'interpLSTn');
load('../data/remote_sensing/for_global_prediction/tair_interp.mat', 'interpAT');
load('../data/remote_sensing/for_global_prediction/surfpres_interp.mat', 'interpSP');
load('../data/remote_sensing/for_global_prediction/cloudfrc_interp.mat', 'interpCF');
load('../data/RSIF_2007_2016_05N_01L.mat', 'RSIF');
%load('../data/remote_sensing/for_global_prediction/fpar_interp.mat', 'interpFPAR');
...
for r = 1:Nrows
    for c = 1:Ncols
        for v = 1:Nvars 
            global_predictor(r, c, 1, v) = global_predictor(r, c, 2, v);
            global_predictor(r, c, end, v) = global_predictor(r, c, end-1, v);
        end
    end
end
...
fprintf('Saving, balling data as global_predictor_rs... \n')
save('../data/remote_sensing/global_predictor.mat', 'global_predictor', '-v7.3');
tar('global_predictor_rs.tar', '../data/remote_sensing/global_predictor.mat');
