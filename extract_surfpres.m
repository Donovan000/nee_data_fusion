...
fprintf('Complete.\n');
%save('./data/surfpres_raw.mat', 'rawSP');
...
fprintf('Complete.\n');       
save('./data/global/surfpres_interp.mat', 'interpSP'); % For prediction
...
save('./data/matched_for_training/surfpres_matched.mat', 'matchedSP');
