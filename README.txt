...
Train and test nonlinear regression with a leave-one-out evaluation strategy. 
There are 209 sites, and we train 209 different ANN regressions, each with 208 sites worth of training data. 
Each regression model is tested on the remaining site not used for training. 
Statistics are calu
