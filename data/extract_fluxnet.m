...
vname = [{'YEAR'},{'DOY'},{'P_ERA'},{'TA_ERA'},{'PA_ERA'},{'SW_IN_ERA'},{'LW_IN_ERA'}...
...
save('./concat/FluxNetDailyData.mat','allData');
save('./concat/FluxNetSiteNames.mat','sname');
save('./concat/FluxNetVarNames.mat','vname');
