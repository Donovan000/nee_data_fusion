...
%% ~~~ NEE+RSIF+MODIS+AIRS Concatenator @ 425 Sites ~~~

% Load source data
fprintf('Loading source data... \n'); tic;
load('./data/matched_for_training/nee_matched.mat', 'matchedNEE');
load('./data/matched_for_training/rsif_matched.mat', 'matchedRSIF');
load('./data/matched_for_training/ndvi_matched.mat', 'matchedNDVI');
load('./data/matched_for_training/lstd_matched.mat', 'matchedLSTd');
load('./data/matched_for_training/lstn_matched.mat', 'matchedLSTn');
load('./data/matched_for_training/tair_matched.mat', 'matchedAT');
load('./data/matched_for_training/surfpres_matched.mat', 'matchedSP');
load('./data/matched_for_training/cloudfrc_matched.mat', 'matchedCF');
%load('./data/matched_for_training/fpar_matched.mat', 'matchedFPAR');


% Concatenate remotely sensed data with Fluxnet+RSIF
...
new_year_transition = nan(1, size(quarterMonGlobals, 2), 425);
...
save('./data/quarterMonGlobals.mat', 'quarterMonGlobals');
